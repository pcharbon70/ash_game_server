defmodule AshGameServer.ECS.EntityExtension do
  ...
  # Define entities section and entities
  defp entity_sections do
    [
      %Spark.Dsl.Section{
        name: :entities,
        describe: """
  ...
  defp entity_template_entity do
    %Spark.Dsl.Entity{
      name: :entity,
      describe: """
  ...
  @impl true
  def sections, do: entity_sections()
